"""
Django settings for a_blog_crm project.
...
SECRET_KEY = 'django-insecure-xn2gja($(mu2)+=n&jvek!!c!j3-6$^nsgw@y#pvhi&f!ieih='
...
WSGI_APPLICATION = 'a_blog_crm.wsgi.application'
